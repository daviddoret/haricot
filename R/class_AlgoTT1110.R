...
#' AlgoTT1110 (R6 class)
#'
#' @description The logical algorithm with truth table 1110 implemented as a NAND-composite.
#'
#' @section Graph:
#' {\figure{algo_tt1110_graph.png}{Graph of the algorithm}}
#'
#' @section Truth table:
#' \tabular{ll}{
