...
#' AlgoTT1100 (R6 class)
#'
#' @description The logical algorithm with truth table 1100 implemented as a NAND-composite.
#'
#' @section Graph:
#' {\figure{algo_tt1100_graph.png}{Graph of the algorithm}}
#'
#' @section Truth table:
#' \tabular{ll}{
