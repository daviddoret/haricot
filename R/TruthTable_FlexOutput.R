...
TruthTable_FlexOutput <- R6Class(
  ...
  public = list(
    ...
    logical_matrix = NULL,
    initialize = function(input_dimension = 1, output_dimension = 1, init_value = FALSE) {
    ...
    do_randomize_outputs = function() {
      ...
      random_logical_vector <- sample(x = c(0,1), size = 2 ^ self$get_input_dimension() * self$get_output_dimension(), replace = TRUE);
