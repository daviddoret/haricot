...
#' AlgoTT0010 (R6 class)
#'
#' @description The logical algorithm with truth table 0010 implemented as a NAND-composite.
#'
#' @section Graph:
#' {\figure{algo_tt0010_graph.png}{Graph of the algorithm}}
#'
#' @section Truth table:
#' \tabular{ll}{
...
AlgoTT0010 <- R6Class(
  ...
  public = list(
    initialize = function(
      ...
      # Apply NAND to the second bit and the inverse of the first input bit.
